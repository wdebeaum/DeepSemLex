  ...
  (W::know
   ...
   (SENSES
    ...
    ((LF-PARENT ONT::KNOW)
     ...
     (TEMPL neutral-theme-xp-templ (xp (% W::cp (w::ctype w::s-that) (w::wh w::-))))
     )
     ((LF-PARENT ONT::know)
    ...
    ((LF-PARENT ONT::KNOWIF)
     ...
     (TEMPL neutral-theme-xp-templ (xp (% W::cp (w::ctype w::s-if) 
					   (w::wh w::-))))
     )
    ((LF-PARENT ONT::KNOWIF)
     (example "I know whether to leave")
      (meta-data :origin csli-ts :entry-date 20070323 :change-date nil :comments nil :wn ("know%2:31:01"))
      (TEMPL neutral-theme-subjcontrol-templ (xp (% W::cp (w::ctype w::s-to) (w::condition (:* ont::pos-condition ?x))
					   (w::wh w::-))))
     )
